    ...
    <Content class="app-body">
        <div class="app-ploter-main">
            <div class="app-ploter-main-body">
                ...
                <el-button @click="onToolSelected">画展位</el-button>
                <!-- 画布容器 -->
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            window.wrapHandshake.$on('evtBusinessDataUnAllot', this.evtBusinessDataUnAllot)
            window.wrapHandshake.$on('evtStageElementRemove', this.evtStageElementRemove)
        },
        mounted () {
            const me = this
            ...
            //获取展馆列表
            me.$axios.post('/zgjbxx/doSearchDataListByVO').then(function (res) {
                this.zgtableData = res.data.result;
            }.bind(this), function (error) {
                console.log(error)
            })
            this.getStage('1082654E5FEB45A6A4372A5C605D0E35')
        },
        methods: {
        ...
        searchClick: function (type) {
            ...
            var params = {
                ...
                // ,
                // orgUuid: this.CONSTANT.currentUser.organizationVO.uuid,
                // orgJgid: this.CONSTANT.currentUser.organizationVO.jgid
            }
            me.$axios.post('/qyjbxx/page', params).then(function (res) {
        ...
        confirm(val) {
            ...
            me.$axios.post('/zwjbxx/doAssign', params).then(function (res) {
        ...
        evtBusinessDataUnAllot(businessData) {
            ...
            me.$axios.post('/zwjbxx/doCancelByVO', params).then(function (res) {
                if (res.data.msg == 'success') {
                    var businessData = this.back2plot(res.data.result)
                    //需要新增
                    //editorHandshake.call('updateBusinessRecord', businessData)
        ...
        evtStageElementRemove(businessData) {
            ...
            me.$axios.post('/zwjbxx/doDelByVO', params).then(function (res) {
                this.$message({
                    message: '删除展位成功',
                    type: 'warning',
                    center: true
        ...
        savePlotData(data) {
            ...
            me.$axios.post('/zwjbxx/doSaveByVO', params).then(function (res) {
                if (res.data.result) {
                    var businessData = this.back2plot(res.data.result)
                    //需要新增
                    //editorHandshake.call('updateBusinessRecord', businessData)
    ...
    //lxy 0225 结束
            ...
            initBusinessData(zgid){
                ...
                me.$axios.post('/zwjbxx/doSearchListByVO', params1).then(function (res) {
                    var businessData = []
