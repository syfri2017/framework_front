    ...
    <div class="main-container" v-loading="loading" element-loading-text="加载中">
      <div id="tableView">
        ...
        <div class="table_container">
          <el-table border id="table" :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" class="tableStyle" :height="tableheight" :row-style="rowStyle" @selection-change="selectionChange">
            ...
            <el-row class="mt20">
              <el-form-item label="展位类型" prop="zwfl">
                <el-radio-group v-model="editForm.zwfl" size="small" @change="zwflChange">
                  <el-radio v-for="item in zwlbData" :key="item.uuid" class="radio" :label="item.codeValue">{{item.codeName}}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-row>
            <el-row>
              <el-form-item v-if="isSngd" label="出口类型" prop="kkfl">
                <el-radio-group v-model="editForm.kkfl" size="small">
                  <el-radio v-for="item in cklxData" :key="item.uuid" class="radio" :label="item.codeValue">{{item.codeName}}</el-radio>
                </el-radio-group>
              </el-form-item>
