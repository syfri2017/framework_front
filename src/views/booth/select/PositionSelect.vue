   ...
   import { mapGetters } from 'vuex'
    ...
    export default {
        ...
        created () {
            ...
            window.wrapHandshake.$on('evtBusinessShapeSelected', this.handlerBusinessShapeSelected)
        },
        mounted () {
            const me = this
            //获取展馆列表
        ...
        //lxy 0225 开始
         getNow: function () {
            const me = this
            me.$axios.post('/zwjbxx/getNow').then(function (res) {
                this.now = res.data
            }.bind(this), function (error) {
                console.log(error)
            })
        ...
        getYxzwData: function () {
            const me = this
            me.$axios.post('/zwjbxx/getSelectedPos').then(function (res) {
        ...
        handlerDel: function (event, uuid) {
            ...
            this.$confirm('此操作将取消该展位选择, 是否继续?', '提示', {
                ...
                if (uuid) {
                    ...
                    const me = this
                    me.$axios.post('/xfxhapi/zwjbxx/doCancelByVO', params).then(function (res) {
        ...
        handlerExport: function () {
            if (this.zguuid) {
                ...
                const me = this
                me.$axios.post('/xfxhapi/zgjbxx/doExportTp', params).then(function (res) {
                    if (res.status == 200) {
                        this.$message({
        ...
        handlerBusinessShapeSelected(data) {
            ...
            this.$confirm(msg, '提示', {
                ...
                me.$axios.post('/zwjbxx/doUpdateByVO', params).then(function (res) {
                    if (res.data.msg == 'success') {
